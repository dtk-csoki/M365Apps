...
if ($M365AppsCheck -and ($PlatformRegistryKey.Platform -eq "x64")) {
    Write-LogEntry -Value "Microsoft 365 Apps x64 detected OK" -Severity 1
    Write-Output "Microsoft 365 Apps x64 Detected"
	Exit 0
   }else{
    Write-LogEntry -Value "Microsoft 365 Apps x64 not detected" -Severity 2
    Exit 1
}
